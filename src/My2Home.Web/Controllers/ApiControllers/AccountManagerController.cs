...
using My2Home.Web.ViewModels.Manage;
...
namespace My2Home.Web.Controllers.ApiControllers
{
    ...
    [ApiController]
    [Authorize]
    public class AccountManagerController : BaseApiController<AccountManagerController>
    {
      ...
      //  private readonly ISmsSender _smsSender;
        ...
        public async Task<IActionResult> VerifyPhoneNumber(string phoneNumber)
        {
            ...
            return phoneNumber == null ? BadRequest("Error") : BadRequest(new VerifyPhoneNumberViewModel { PhoneNumber = phoneNumber });
        }
